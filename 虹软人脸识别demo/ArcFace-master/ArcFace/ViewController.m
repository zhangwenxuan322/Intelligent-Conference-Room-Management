...
//    if (![self isBlankString:personName]){
//        NSString *result = [personName stringByAppendingString:@"签到成功!"];
...
- (void)showAlert:(NSString *)title {
    UIAlertController* alert = [UIAlertController alertControllerWithTitle:@"签到"
                                                                   message:title
